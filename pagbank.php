...
class PagBank extends PaymentModule
{
	...
	public function getContent()
	{
		...
		$this->context->smarty->assign(array(
			...
			'new_user_state_d14' => urlencode(basename(_PS_ADMIN_DIR_) . '/registerUser/D14/' . $token_ps),
			'new_user_state_d30' => urlencode(basename(_PS_ADMIN_DIR_) . '/registerUser/D30/' . $token_ps),
			'new_user_state_tax' => urlencode(basename(_PS_ADMIN_DIR_) . '/registerUser/TAX/' . $token_ps),
